...
export function gatewayClientInstructions(
	...
	if (oauth) {
		const instructions = [
			...
			'Authentication: OAuth using my organization account.',
			...
			'Use the MCP client’s OAuth sign-in flow. Let me choose my organization identity provider if offered, complete sign-in in the browser, and approve the requested connection. Do not ask me to paste credentials or tokens into chat.',
