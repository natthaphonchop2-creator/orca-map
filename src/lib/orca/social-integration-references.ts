...
export const socialIntegrationReferences: IntegrationReference[] = [
  {
    ...
    requirements: [
      ['ใช้บัญชี Meta Developer ที่มีสิทธิ์ในแอป และอนุญาตผ่าน OAuth', 'Use a Meta Developer account with access to the app and authorize through OAuth.'],
      ['บริการอยู่ใน Beta และจำกัด MCP client ที่ Meta อนุมัติ ต้องตรวจว่า ORCA ได้รับอนุญาตก่อน', 'This beta restricts access to Meta-approved MCP clients. Confirm ORCA is approved before connecting.'],
    ],
  ...
  },
  {
    ...
    requirements: [
      ...
      ['อนุญาตผ่าน OAuth แล้วเลือกเฉพาะเครื่องมือที่ทีมจะใช้งาน', 'Authorize through OAuth, then select only the tools your team will use.'],
    ],
  ...
  },
  {
    ...
    requirements: [
      ...
      ['หากใช้กับเพจของลูกค้าภายนอก ให้ตรวจข้อกำหนด App Review และ Advanced Access ของ Meta', 'For external customer Pages, check Meta App Review and Advanced Access requirements.'],
    ],
  ...
  },
  {
    ...
    requirements: [
      ['ลงทะเบียน TikTok Developer app เปิด Content Posting API และขอ scope video.publish', 'Register a TikTok Developer app, enable Content Posting API, and request video.publish.'],
      ['เจ้าของบัญชีอนุญาตผ่าน OAuth; ต้องผ่านการตรวจแอปก่อนเผยแพร่แบบสาธารณะ', 'The account owner authorizes through OAuth. An app audit is required for public publishing.'],
      ['ต้องติดตั้ง API adapter และให้ผู้ใช้ตรวจงานก่อนเผยแพร่', 'Implement an API adapter and provide the required user review before publishing.'],
    ],
    scope: ["เจ้าของบัญชีต้องอนุญาตแอปและตรวจเนื้อหาก่อนเผยแพร่ แอปต้องผ่านการตรวจของ TikTok จึงจะโพสต์แบบสาธารณะได้", "The account owner authorizes the app and reviews content before publishing. Public posts require a TikTok app audit."],
